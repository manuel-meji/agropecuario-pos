          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              ...
              {filteredSuppliers.length === 0 && (
                <tr>
                    <td colSpan={6} className="p-8 text-center text-gray-400">No hay proveedores registrados o tu búsqueda no arrojó resultados.</td>
                </tr>
              )}
            </tbody>
          </table>
        ...
        {isModalOpen && (
          <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-lg shadow-2xl">
              <h3 className="text-lg font-bold mb-4 dark:text-white">Registrar Proveedor</h3>
